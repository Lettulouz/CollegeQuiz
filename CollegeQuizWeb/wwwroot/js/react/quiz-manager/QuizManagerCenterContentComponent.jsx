import { SESS_TOKEN, QR_CODE_BLOB, copyToClipboard, SessionContext } from "./QuizManagerRenderer.jsx";

import QuizPlayerViewResultComponent from "./QuizPlayerViewResultComponent.jsx";

const QuizManagerCenterContentComponent = () => {
    const { lobbyData, counting, countingActive, isEnded } = React.useContext(SessionContext);
