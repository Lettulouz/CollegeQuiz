    ...
    return (
        <div className="container">
            ...
            <div className="leaderboard streak fw-bold fs-1 mx-2 px-5 col-sm" ref={leaderRef}>
                <div class="icon-animation"><i className="bi bi-lightning-charge-fill text-warning fs-1 icon-animation"></i></div>
                <div className="flex-fill text-center">
                    {afterQuestionResults[lastItem].Username}: {afterQuestionResults[lastItem].CurrentStreak}
                </div>
                <div class="icon-animation"><i className="bi bi-lightning-charge-fill text-warning fs-1"></i></div>
            </div>
